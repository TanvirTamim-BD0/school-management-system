...
@section('content')
@section('title') Academic Exam Create @endsection
    ...
    <div class="container">
      <div class="row">
        <div class="col s10 m6 l6">
          <h5 class="breadcrumbs-title mt-0 mb-0"><span>Academic Exam Create</span></h5>
          <ol class="breadcrumbs mb-0">
            <li class="breadcrumb-item"><a href="{{route('home')}}">Home</a>
            </li>
            <li class="breadcrumb-item"><a href="#">Academic Exam</a>
            </li>
            <li class="breadcrumb-item active">Academic Exam Create
            </li>
          </ol>
        </div>
      </div>
    ...
    <div class="card">
      <div class="card-content">
        ...
        <div class="row">
          ...
          <form class="col s12" method="post" action="{{route('academic-exam.store')}}" enctype="multipart/form-data">
            @csrf
            <div class="row">
              ...
              <div class="input-field col s12 m6">
                <select class="select2 browser-default" name="exam_name" id="exam_name" required
                  value="{{ old('exam_name') }}">
                  <option value="" disabled selected>Select Exam <span class="custom-text-danger">*</span>
                  </option>
                  @foreach($getExam as $exam)
                  <option value="{{$exam}}" class="left circle">{{$exam}}</option>
                  @endforeach
