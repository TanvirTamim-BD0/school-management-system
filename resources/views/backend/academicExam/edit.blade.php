...
@section('content')
@section('title') Academic Exam Edit @endsection
@section('academic-exam') active @endsection
@section('academic-exam') active @endsection
@section('styles')
@endsection
@section('content')
    ...
    <div class="container">
      <div class="row">
        <div class="col s10 m6 l6">
          <h5 class="breadcrumbs-title mt-0 mb-0"><span>Academic Exam Edit</span></h5>
          <ol class="breadcrumbs mb-0">
            <li class="breadcrumb-item"><a href="{{route('home')}}">Home</a>
            </li>
            <li class="breadcrumb-item"><a href="#">Academic Exam</a>
            </li>
            <li class="breadcrumb-item active"> Academic Exam Edit
            </li>
          </ol>
        </div>
      </div>
      ...
      <div class="card-content">
        ...
        <div class="float-right">
          ...
          <a class="waves-effect waves dark btn gradient-45deg-purple-deep-orange next-step add-attendance-button"
            href="{{route('academic-exam.index')}}">
        ...
        <div class="row">
          ...
          <form class="col s12" method="post" action="{{route('academic-exam.update',$exam->id)}}" enctype="multipart/form-data">
            @csrf
            @method('put')
            <div class="row">
                ...
                <div class="input-field">
                  <select class="select2 browser-default" id="class_id" name="class_id" required>
                    ...
                    <option value="{{ $singleClassData->id }}"
                      {{ $singleClassData->id == $exam->class_id ? 'selected' : ''}}>{{ $singleClassData->class_name }}
                    </option>
                    @endif
                    @endforeach
                  </select>
              ...
              $arraySectionIds = json_decode($exam->section_id);
              @endphp
                ...
                <div class="input-field">
                  <select class="select2 browser-default" name="subject_id" id="subject_id" required>
                    ...
                    <option value="{{ $singleSubjectData->id }}"
                      {{ $singleSubjectData->id == $exam->subject_id ? 'selected' : ''}}>
                      {{ $singleSubjectData->subject_name }}</option>
                    @endif
                    @endforeach
                  </select>
                </div>
              ...
              <div class="input-field col s12 m6">
                <input id="exam_date" type="text" class="datepicker" name="exam_date" required value="{{$singleDate}}"
                  required>
              ...
              <div class="input-field col s12 m6">
                <input id="total_mark" type="text" class="validate" name="total_mark" value="{{$exam->total_mark}}"
                  required>
              ...
              <div class="input-field col s12 m6">
                <input id="pass_mark" type="text" class="validate" name="pass_mark" value="{{$exam->pass_mark}}"
                  required>
