...
@section('content')
@section('title') Academic Exam @endsection
@section('academic-exam') active @endsection
@section('academic-exam.index') active @endsection
@section('styles')
@endsection
@section('content')
    ...
    <div class="container">
      <div class="row">
        <div class="col s10 m6 l6">
          <h5 class="breadcrumbs-title mt-0 mb-0"><span>Academic Exam List</span></h5>
          <ol class="breadcrumbs mb-0">
            <li class="breadcrumb-item"><a href="{{route('home')}}">Home</a>
            </li>
            <li class="breadcrumb-item"><a href="#">Academic Exam</a>
            </li>
            <li class="breadcrumb-item active">Academic Exam List
            </li>
          </ol>
        </div>
      </div>
  ...
  <div class="col s12">
    <div class="card">
      ...
      <div class="card-content custom-card-content custom-card-content-for-datatable">
        <h2 class="card-title">Academic Exam Record List</h2>
        <div class="float-right justify-content-end">
          @if(Auth::user()->can('exam-create'))
          <a class="waves-effect waves dark btn gradient-45deg-purple-deep-orange next-step add-attendance-button"
            href="{{route('academic-exam.create')}}">
        ...
        <table id="sectionTable"
          ...
          <tbody>
            ...
            <tr>
              ...
              $getAllSectionData = App\Models\AcademicExam::getAllSectionDataWithExamIdWise($exam->id);
              @endphp
              ...
              <td class=" text-center">
                ...
                <ul id='dropdown1{{$exam->id}}' class='dropdown-content custom-dropdown-for-action'>
                  ...
                  @if($exam->status == 0)
                  <li>
                    <a href="{{ route('academic-exam.result',$exam->id) }}"><i class="material-icons">checklist</i>Create
                      Result</a>
                  </li>
                  @else
                  @endif
                  ...
                  <li>
                    <a href="{{ route('academic-exam.edit',$exam->id) }}"><i class="material-icons">edit</i>Edit</a>
                  </li>
                  @endif
                ...
                <form id="delete-form" action="{{ route('academic-exam.destroy', $exam->id) }}" method="POST"
                  style="display: none;">
                  @csrf
                  @method('delete')
                </form>
