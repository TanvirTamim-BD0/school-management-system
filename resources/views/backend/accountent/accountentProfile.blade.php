...
@section('content')
@section('title') Accountent Profile @endsection
        ...
        <div class="container">
            <div class="row">
                <div class="col s10 m6 l6">
                    <h5 class="breadcrumbs-title mt-0 mb-0"><span>Accountent Profile</span></h5>
                    <ol class="breadcrumbs mb-0">
                        <li class="breadcrumb-item"><a href="{{route('home')}}">Home</a>
                        </li>
                        <li class="breadcrumb-item active">Accountent Profile
                        </li>
                    </ol>
                </div>
            </div>
    ...
    <div class="col s12">
        <div class="card mb-0">
            <div class="card-content custom-card-content">
                <h2 class="card-title">Accountent Profile</h2>
            ...
            <div class="row">
                <div class="col l3 s12 mt-1">
                    ...
                    <div class="card-panel">
                                        ...
                                        <div class="sidebar-details">
                                            <div class="row valign-wrapper pt-2 animate fadeLeft">
                                                <div class="col s12 media-image text-center">
                                                    ...
                                                    @if(isset($singleAccountent->accountent_photo) && $singleAccountent->accountent_photo !=
                                                    null)
                                                    <img src="{{ asset('/uploads/accountent_photo/'.$singleAccountent->accountent_photo) }}"
                                                        width="75" height="65">
                                                    @else
                                                    @if($singleAccountent->gender == 'male')
                                            ...
                                            <div class="card-content custom-student-account-profile mt-10">
                                                ...
                                                <p>
                                                    ...
                                                    <span
                                                        class="custom-student-account-profile-content">{{$singleAccountent->accountent_name}}</span>
                                                </p>

                                                <p>
                                                    <i class="material-icons profile-card-i">call</i>
                                                    <span
                                                        class="custom-student-account-profile-content">{{$singleAccountent->accountent_phone}}</span>
                                                </p>

                                                <p>
                                                    <i class="material-icons profile-card-i">email</i>
                                                    <span
                                                        class="custom-student-account-profile-content">{{$singleAccountent->accountent_email}}</span>
                                                </p>
                                                <p><i class="material-icons profile-card-i">person_outline</i>
                                                    <span class="custom-student-account-profile-content"> <span
                                                            class="custom-text-info">({{$singleAccountent->blood_group}})</span>
                                                    </span>
                                                </p>
                                                <p><i class="material-icons profile-card-i">eject</i>
                                                    <span class="custom-student-account-profile-content">
                                                        {{$singleAccountent->religion}}
                                                    </span>
                                                </p>
                                                <p>
                                                    <i class="material-icons profile-card-i">directions</i>
                                                    <span
                                                        class="custom-student-account-profile-content">{{$singleAccountent->address}}</span>
                                                </p>

                                                <p>
                                                    <i class="material-icons profile-card-i">assignment_add</i>
                                                    <span
                                                        class="custom-student-account-profile-content">{{Carbon\Carbon::createFromFormat('Y-m-d', $singleAccountent->joining_date)->format('d-m-Y')}}</span>
                                                </p>
                        ...
                        <a href="{{ route('accountent.edit',$singleAccountent->id) }}" class="btn waves-effect waves-light purple lightrn-1 editbutton">edit</a>
                    </div>
                </div>
                                ...
                                <div class="card-content">
                                    ...
                                    <div class="row">
                                            ...
                                            <div id="attendanceWitMonth">
                                                <table
                                                    ...
                                                    <tbody>
                                                        ...
                                                        @php
                                                        $presentData =
                                                        App\Models\AccountentAttendance::presentDataWithMonth($month,$singleAccountent->id);
                                                        $absenceData =
                                                        App\Models\AccountentAttendance::absenceDataWithMonth($month,$singleAccountent->id);
                                                        $lateData =
                                                        App\Models\AccountentAttendance::lateDataWithMonth($month,
                                                        $singleAccountent->id);
                                                        $leaveData =
                                                        App\Models\AccountentAttendance::leaveDataWithMonth($month,
                                                        $singleAccountent->id);
                                                        @endphp
                                                        ...
                                                        <tr>
                                                            <td class="font-weight-bold text-left">
                                                                <a href="#"
                                                                    onclick="teacherAttendense({{$singleAccountent->id}},'{{$month}}')">
                                                                    {{ $month }}
                                                                </a>
                                                            </td>
                                        ...
                                        <div class="col s12" id="paymentHistory" class="">
                                            <h2 class="card-title custom-payment-title mt-1">Accountent Payment
                                                History</h2>
                                            <div class="divider"></div>
                                            
                                            <div class="card-content-datatable table-responsive">
                                                <table id="accountentPH"
...
<script>
    //To fetch the course days attendance with month...
		    function teacherAttendense(accountentId, monthName) {

		        var url = "{{ route('accountent.daysAttendanceWithMonth') }}";
		        if(accountentId != ''){
		            $.ajaxSetup({
		                headers: {
