...
<a href="{{ route('accountent-profile',$singleAccountent->id) }}" 
...
<div id="attendanceWitMonth">
	...
	<table class="table table-striped text-center table-bordered dt-responsive nowrap">
		...
		<tbody>
			...
			@php
			$data = App\Models\AccountentAttendance::accountentAttendance($singleAccountent->id, $date);
			@endphp
			...
			<tr class=" text-center">
				...
				<td>
					...
					<span class="common-status-padding badge badge-light-primary p-1 "
						style="color: #F4A460;">Late</span>
					@else
				...
				<td>
					...
					<span class="common-status-padding badge badge-light-warning p-1 "
						style="color: #1E90FF;">Leave</span>
					@else
