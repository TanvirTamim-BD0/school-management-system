...
@section('content')
@section('title') Accountent Attendance Update @endsection
            ...
            <div class="row">
                <div class="col s10 m6 l6">
                    ...
                    <ol class="breadcrumbs mb-0">
                        ...
                        <li class="breadcrumb-item active">Accountent Attendance Update
                        </li>
                    </ol>
                </div>
            </div>
    ...
    <div class="col s12">
        ...
        <div class="card">
            ...
            <div
                ...
                <form method="POST" action="{{ route('attendace-of-accountent.update', $data->id) }}" class="d-inline">
                    @csrf
                    @method('put')
                    ...
                    <table id=""
                        ...
                        <tbody>
                            ...
                            <tr>
                                <input type="hidden" name="accountent_id[]" value="{{ $item->accountent_id }}">
                                <input type="hidden" name="date" value="{{ $selectedDate }}">

                                <td>{{ $loop->iteration }}</td>
                                <td class="custom-attendance-image">
                                    @if(isset($item->accountentData->accountent_photo) && $item->accountentData->accountent_photo != null)
                                    <img src="{{ asset('/uploads/accountent_photo/'.$item->accountentData->accountent_photo) }}" width="75"
                                        height="65">
                                    @else
                                    @if($item->gender == 'male')
                                ...
                                <td class="custom-academic-details">
                                    Name: {{$item->accountentData->accountent_name}} <br>
                                    Gmail: {{$item->accountentData->accountent_email}} <br>
                                </td>
                                ...
                                <td class="custom-attendance-action-button">
                                    <div class="btn-group">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <label>
                                                <input class="with-gap" type="radio" id="present{{ $item->accountent_id }}"
                                                    name="attendance[{{ $item->accountent_id }}]" value="present" 
                                        ...
                                        <div class="form-check form-check-inline">
                                            <label>
                                                <input class="with-gap" type="radio" id="absence{{ $item->accountent_id }}"
                                                    name="attendance[{{ $item->accountent_id }}]" value="absence" 
                                        ...
                                        <div class="form-check form-check-inline">
                                            <label>
                                                <input class="with-gap" type="radio" id="late{{ $item->accountent_id }}"
                                                    name="attendance[{{ $item->accountent_id }}]" value="late" 
                                                    {{$item->late == 1 ? 'checked' : '' }} />
                                        ...
                                        <div class="form-check form-check-inline">
                                            <label>
                                                <input class="with-gap" type="radio" id="leave{{ $item->accountent_id }}"
                                                    name="attendance[{{ $item->accountent_id }}]" value="leave" 
                    ...
                    <div class="form-submit-section text-center custom-attendance-footer-button">
                        <a class="btn btn-danger back-button" href="{{ route('attendace-of-accountent.index') }}">
