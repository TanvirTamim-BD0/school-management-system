            ...
            <div class="row">
                <div class="col s10 m6 l6">
                    ...
                    <ol class="breadcrumbs mb-0">
                        ...
                        <li class="breadcrumb-item active">Librarian Attendance Create
                        </li>
                    </ol>
                </div>
            </div>
    ...
    <div class="col s12">
        ...
        <div class="card">
            ...
            <div class="card-content-datatable table-responsive custom-filter-content-datatable custom-attendance-table">
                <form method="POST" action="{{ route('attendace-of-librarian.store') }}" class="d-inline">
                    @csrf
                    ...
                    <table id=""
                        ...
                        <tbody>
                            ...
                            <tr>
                                <input type="hidden" name="librarian_id[]" value="{{ $item->id }}">
                                <input type="hidden" name="date" value="{{ $selectedDate }}">

                                <td>{{ $loop->iteration }}</td>
                                <td class="custom-attendance-image">
                                    @if(isset($item->librarian_photo) && $item->librarian_photo != null)
                                    <img src="{{ asset('/uploads/librarian_photo/'.$item->librarian_photo) }}" width="75"
                                        height="65">
                                    @else
                                        @if($item->gender == 'male')
