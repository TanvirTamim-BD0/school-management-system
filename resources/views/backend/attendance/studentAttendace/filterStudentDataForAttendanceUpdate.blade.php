...
@section('content')
@section('title') Student Attendance Update @endsection
            ...
            <div class="row">
                <div class="col s10 m6 l6">
                    ...
                    <ol class="breadcrumbs mb-0">
                        ...
                        <li class="breadcrumb-item active">Student Attendance Update
                        </li>
                    </ol>
                </div>
            </div>
    ...
    <div class="col s12">
        ...
        <div class="card">
            ...
            <div
                ...
                <form method="POST" action="{{ route('attendace-of-student.update', $data->id) }}" class="d-inline">
                    @csrf
                    @method('put')
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="custom-attendance-image">
                                    @if(isset($item->studentData->student_photo) && $item->studentData->student_photo != null)
                                    <img src="{{ asset('/uploads/student_photo/'.$item->studentData->student_photo) }}" width="75"
                                        height="65">
                                    @else
                                    @if($item->gender == 'male')
                                ...
                                <td class="custom-attendance-action-button">
                                    <div class="btn-group">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <label>
                                                <input class="with-gap" type="radio" id="present{{ $item->student_id }}"
                                                    name="attendance[{{ $item->student_id }}]" value="present" 
                                        ...
                                        <div class="form-check form-check-inline">
                                            <label>
                                                <input class="with-gap" type="radio" id="absence{{ $item->student_id }}"
                                                    name="attendance[{{ $item->student_id }}]" value="absence" 
                                        ...
                                        <div class="form-check form-check-inline">
                                            <label>
                                                <input class="with-gap" type="radio" id="late{{ $item->student_id }}"
                                                    name="attendance[{{ $item->student_id }}]" value="late" 
                                                    {{$item->late == 1 ? 'checked' : '' }} />
                                        ...
                                        <div class="form-check form-check-inline">
                                            <label>
                                                <input class="with-gap" type="radio" id="leave{{ $item->student_id }}"
                                                    name="attendance[{{ $item->student_id }}]" value="leave" 
