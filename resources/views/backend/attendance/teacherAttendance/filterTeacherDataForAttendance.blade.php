            ...
            <div class="row">
                <div class="col s10 m6 l6">
                    ...
                    <ol class="breadcrumbs mb-0">
                        ...
                        <li class="breadcrumb-item active">Teacher Attendance Create
                        </li>
                    </ol>
                </div>
            </div>
    ...
    <div class="col s12">
        ...
        <div class="card">
            ...
            <div class="card-content-datatable table-responsive custom-filter-content-datatable custom-attendance-table">
                <form method="POST" action="{{ route('attendace-of-teacher.store') }}" class="d-inline">
                    @csrf
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="custom-attendance-image">
                                    ...
                                    <img src="{{ asset('/uploads/teacher_photo/'.$item->teacher_photo) }}" width="75"
                                        height="65">
                                    @else
                                        @if($item->gender == 'male')
