...
@section('content')
@section('title') Teacher Attendance Update @endsection
@section('attendace-of-teacher') active @endsection
@section('attendace-of-teacher.index') active @endsection
@section('styles')
@endsection
        ...
        <div class="container">
            <div class="row">
                <div class="col s10 m6 l6">
                    <h5 class="breadcrumbs-title mt-0 mb-0"><span>Teacher Attendance List</span></h5>
                    <ol class="breadcrumbs mb-0">
                        <li class="breadcrumb-item"><a href="{{route('home')}}">Home</a>
                        </li>
                        <li class="breadcrumb-item active">Teacher Attendance Update
                        </li>
                    </ol>
                </div>
            </div>
    ...
    <div class="col s12">
            ...
            <div
                ...
                <div class="float-right justify-content-end">
                    <div class="float-right justify-content-end custom-class-date">
                        ...
                        <h5>Teachers: <span class="custom-text-gray">{{ $teacherData->count() }}</span></h5>
                    </div>
                </div>
            </div>
        ...
        <div class="card">
            ...
            <div
                ...
                <form method="POST" action="{{ route('attendace-of-teacher.update', $data->id) }}" class="d-inline">
                    @csrf
                    @method('put')
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="custom-attendance-image">
                                    @if(isset($item->teacherData->teacher_photo) && $item->teacherData->teacher_photo != null)
                                    <img src="{{ asset('/uploads/teacher_photo/'.$item->teacherData->teacher_photo) }}" width="75"
                                        height="65">
                                    @else
                                    @if($item->gender == 'male')
                                ...
                                <td class="custom-academic-details">
                                    Name: {{$item->teacherData->teacher_name}} <br>
                                    Gmail: {{$item->teacherData->teacher_email}} <br>
                                </td>
                                ...
                                <td class="custom-attendance-action-button">
                                    <div class="btn-group">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <label>
                                                <input class="with-gap" type="radio" id="present{{ $item->teacher_id }}"
                                                    name="attendance[{{ $item->teacher_id }}]" value="present" 
                                        ...
                                        <div class="form-check form-check-inline">
                                            <label>
                                                <input class="with-gap" type="radio" id="absence{{ $item->teacher_id }}"
                                                    name="attendance[{{ $item->teacher_id }}]" value="absence" 
                                        ...
                                        <div class="form-check form-check-inline">
                                            <label>
                                                <input class="with-gap" type="radio" id="late{{ $item->teacher_id }}"
                                                    name="attendance[{{ $item->teacher_id }}]" value="late" 
                                                    {{$item->late == 1 ? 'checked' : '' }} />
                                        ...
                                        <div class="form-check form-check-inline">
                                            <label>
                                                <input class="with-gap" type="radio" id="leave{{ $item->teacher_id }}"
                                                    name="attendance[{{ $item->teacher_id }}]" value="leave" 
