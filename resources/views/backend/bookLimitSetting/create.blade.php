...
@section('content')
@section('title') Book Limit Create @endsection
@section('book-limit-setting') active @endsection
@section('book-limit-setting.create') active @endsection
@section('styles')
@endsection
@section('content')
    ...
    <div class="container">
      <div class="row">
        <div class="col s10 m6 l6">
          <h5 class="breadcrumbs-title mt-0 mb-0"><span>Book Limit Create</span></h5>
          <ol class="breadcrumbs mb-0">
            <li class="breadcrumb-item"><a href="{{route('home')}}">Home</a>
            </li>
            <li class="breadcrumb-item"><a href="#">Book Limit</a>
            </li>
            <li class="breadcrumb-item active">Book Limit Create
            </li>
          </ol>
        </div>
      </div>
      ...
      <div class="card-content">
        ...
        <div class="float-right">
          ...
          <a class="waves-effect waves dark btn gradient-45deg-purple-deep-orange next-step add-attendance-button"
            href="{{route('book-limit-setting.index')}}">
        ...
        <div class="row">
          ...
          <form class="col s12" method="post" action="{{route('book-limit-setting.store')}}">
            @csrf
            <div class="row">
              ...
              <div class="input-field col s12 m6">
                <select class="select2 browser-default" name="role" required>
                  ...
                  <option value="{{$role->name}}" class="left circle">{{$role->name}}</option>
                  @endforeach
