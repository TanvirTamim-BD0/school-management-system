...
@section('content')
@section('title') Book Limit @endsection
@section('book-limit-setting') active @endsection
@section('book-limit-setting.index') active @endsection
@section('styles')
@endsection
@section('content')
    ...
    <div class="container">
      <div class="row">
        <div class="col s10 m6 l6">
          <h5 class="breadcrumbs-title mt-0 mb-0"><span>Book Limit List</span></h5>
          <ol class="breadcrumbs mb-0">
            <li class="breadcrumb-item"><a href="{{route('home')}}">Home</a>
            </li>
            <li class="breadcrumb-item"><a href="#">Book Limit</a>
            </li>
            <li class="breadcrumb-item active">Book Limit List
            </li>
          </ol>
        </div>
      </div>
  ...
  <div class="col s12">
    <div class="card">
      ...
      <div class="card-content custom-card-content custom-card-content-for-datatable">
        <h2 class="card-title">Book Limit Record List</h2>
        <div class="float-right justify-content-end">
          @if(Auth::user()->can('section-create'))
          <a class="waves-effect waves dark btn gradient-45deg-purple-deep-orange next-step add-attendance-button"
            href="{{route('book-limit-setting.create')}}">
            <i class="material-icons dp48">add_circle_outline</i> Add Book Limit
          </a>
          @endif
        </div>
      </div>
        ...
        <table id="sectionTable"
          ...
          <thead>
            <tr>
              ...
              <th class="custom-border-right">Number</th>
            ...
            <tr>
              ...
              <td class=" text-center">
                ...
                <ul id='dropdown1{{$item->id}}' class='dropdown-content custom-dropdown-for-action'>
                  ...
                  <li>
                    <a href="{{ route('book-limit-setting.edit',$item->id) }}"><i class="material-icons">edit</i>Edit</a>
                  </li>
                  @endif

                  @if(Auth::user()->can('section-delete'))
                  <li>
                    <a href="{{ route('book-limit-setting.destroy', $item->id) }}" onclick="event.preventDefault();
                ...
                <form id="delete-form" action="{{ route('book-limit-setting.destroy', $item->id) }}" method="POST"
                  style="display: none;">
                  @csrf
                  @method('delete')
                </form>
