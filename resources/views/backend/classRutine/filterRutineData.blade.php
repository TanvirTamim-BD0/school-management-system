...
@section('content')
@section('title') Class Routin @endsection
...
<div class="row">
        ...
        <div class="container">
            <div class="row">
                <div class="col s10 m6 l6">
                    <h5 class="breadcrumbs-title mt-0 mb-0"><span>Class Routine List</span></h5>
                    <ol class="breadcrumbs mb-0">
                        <li class="breadcrumb-item"><a href="{{route('home')}}">Home</a>
                        </li>
                        <li class="breadcrumb-item"><a href="#">Class Routine</a>
                        </li>
                        <li class="breadcrumb-item active">Class Routine List
                        </li>
                    </ol>
                </div>
            </div>
    ...
    <div class="col s12">
        ...
        <div class="card">
            ...
            <table id="" class="display custom-table custom-data-table custom-table-border dt-responsive nowrap table-responsive">
                ...
                <tbody>
                  <tr>
                    ...
                    <td class="custom-border-right">
                      ...
                      <br>
                      <a href="{{ route('classRoutine.edit', $saturday->id) }}" style="color: #f59c1a;"><i class="material-icons">edit_square</i></a>

                      <a href="{{ route('classRoutine.destroy', $saturday->id) }}" onclick="event.preventDefault();
                          document.getElementById('delete-form').submit();"><i
                          class="material-icons" style="color: #F35A57;" >delete</i></a>

                      <form id="delete-form" action="{{ route('classRoutine.destroy', $saturday->id) }}" method="POST" style="display: none;">
                          @csrf
                          @method('delete')
                      </form>
                  ...
                  <tr>
                    ...
                    <td class="custom-border-right">
                      ...
                      <a href="{{ route('classRoutine.edit', $sunday->id) }}" style="color: #f59c1a;"><i class="material-icons">edit_square</i></a>

                      <a href="{{ route('classRoutine.destroy', $sunday->id) }}" onclick="event.preventDefault();
                          document.getElementById('delete-form').submit();"><i
                          class="material-icons" style="color: #F35A57;" >delete</i></a>

                      <form id="delete-form" action="{{ route('classRoutine.destroy', $sunday->id) }}" method="POST" style="display: none;">
                          @csrf
                          @method('delete')
                      </form>
                    </td>
                  ...
                  <tr>
                    ...
                    <td class="custom-border-right">
                      ...
                      <a href="{{ route('classRoutine.edit', $monday->id) }}" style="color: #f59c1a;"><i class="material-icons">edit_square</i></a>

                      <a href="{{ route('classRoutine.destroy', $monday->id) }}" onclick="event.preventDefault();
                          document.getElementById('delete-form').submit();"><i
                          class="material-icons" style="color: #F35A57;" >delete</i></a>

                      <form id="delete-form" action="{{ route('classRoutine.destroy', $monday->id) }}" method="POST" style="display: none;">
                          @csrf
                          @method('delete')
                      </form>
                  ...
                  <tr>
                    ...
                    <td class="custom-border-right">
                      ...
                      <a href="{{ route('classRoutine.edit', $tuesday->id) }}" style="color: #f59c1a;"><i class="material-icons">edit_square</i></a>

                      <a href="{{ route('classRoutine.destroy', $tuesday->id) }}" onclick="event.preventDefault();
                          document.getElementById('delete-form').submit();"><i
                          class="material-icons" style="color: #F35A57;" >delete</i></a>

                      <form id="delete-form" action="{{ route('classRoutine.destroy', $tuesday->id) }}" method="POST" style="display: none;">
                          @csrf
                          @method('delete')
                      </form>
                  ...
                  <tr>
                    ...
                    <td class="custom-border-right">
                      ...
                      <a href="{{ route('classRoutine.edit', $wednesday->id) }}" style="color: #f59c1a;"><i class="material-icons">edit_square</i></a>

                      <a href="{{ route('classRoutine.destroy', $wednesday->id) }}" onclick="event.preventDefault();
                          document.getElementById('delete-form').submit();"><i
                          class="material-icons" style="color: #F35A57;" >delete</i></a>

                      <form id="delete-form" action="{{ route('classRoutine.destroy', $wednesday->id) }}" method="POST" style="display: none;">
                          @csrf
                          @method('delete')
                      </form>
                    </td>
                  ...
                  <tr>
                    ...
                    <td class="custom-border-right">
                      ...
                      <a href="{{ route('classRoutine.edit', $thursday->id) }}" style="color: #f59c1a;"><i class="material-icons">edit_square</i></a>

                      <a href="{{ route('classRoutine.destroy', $thursday->id) }}" onclick="event.preventDefault();
                          document.getElementById('delete-form').submit();"><i
                          class="material-icons" style="color: #F35A57;" >delete</i></a>

                      <form id="delete-form" action="{{ route('classRoutine.destroy', $thursday->id) }}" method="POST" style="display: none;">
                          @csrf
                          @method('delete')
                      </form>
                    </td>
