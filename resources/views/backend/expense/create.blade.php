    ...
    <div class="container">
      <div class="row">
        <div class="col s10 m6 l6">
          <h5 class="breadcrumbs-title mt-0 mb-0"><span>Expense Create</span></h5>
    ...
    <div class="card">
      <div class="card-content">
        ...
        <div class="row">
          ...
          <form class="col s12" method="post" action="{{route('expense.store')}}">
            @csrf
            <div class="row">

              <div class="input-field col s12 m6">
                <input id="expense_title" type="text" class="validate" name="expense_title" required value="{{ old('expense_title') }}" > 
              ...
              <div class="input-field col s12 m6">
                <input id="expense_date" type="text" class="datepicker" name="expense_date" required value="{{ old('expense_date') }}" >
              ...
              <div class="input-field col s12 m6">
                <input id="expense_amount" type="number" class="validate" name="expense_amount" required value="{{ old('expense_amount') }}" >
              ...
              <div class="input-field col s12 m6">
                <input id="expense_note" type="text" class="validate" name="expense_note" required value="{{ old('expense_note') }}" >
