...
@section('content')
@section('title') Fees Assign Create @endsection
@section('fees-assign') active @endsection
@section('fees-assign.create') active @endsection
@section('styles')
@endsection
@section('content')
    ...
    <div class="container">
      <div class="row">
        <div class="col s10 m6 l6">
          <h5 class="breadcrumbs-title mt-0 mb-0"><span>Fees Assign Create</span></h5>
          <ol class="breadcrumbs mb-0">
            <li class="breadcrumb-item"><a href="{{route('home')}}">Home</a>
            </li>
            <li class="breadcrumb-item"><a href="#">Fees Assign</a>
            </li>
            <li class="breadcrumb-item active">Fees Assign Create
            </li>
          </ol>
        </div>
      </div>
    ...
    <div class="card">
      <div class="card-content " id="html-validations">
        ...
        <div class="row" id="html-view-validations">
          ...
          <form class="col s12" method="post" action="{{route('fees-assign.store')}}" lass="formValidate0"
            ...
            <div class="row">
              ...
              <div class="col m6  s12">
                <div class="input-field">
                  <select class="select2 browser-default error validate" id="class_id" name="class_id" required>
              ...
              <div class="col m6  s12">
                <div class="input-field">
                  <select class="select2 browser-default error validate" id="fees_type_id" name="fees_type_id" required>
              ...
              <div class="col m12  s12">
                <div class="input-field">
                  <input id="icon_prefix" type="number" class="validate" name="fees_amount" id="fees_amount" required>
