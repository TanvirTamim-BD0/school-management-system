...
@section('content')
@section('title') Holiday Update @endsection
@section('holiday') active @endsection
@section('holiday.update') active @endsection
@section('styles')
@endsection
@section('content')
    ...
    <div class="container">
      <div class="row">
        <div class="col s10 m6 l6">
          <h5 class="breadcrumbs-title mt-0 mb-0"><span>Holiday Update</span></h5>
          <ol class="breadcrumbs mb-0">
            <li class="breadcrumb-item"><a href="{{route('home')}}">Home</a>
            </li>
            <li class="breadcrumb-item"><a href="#">Holiday</a>
            </li>
            <li class="breadcrumb-item active">Holiday Update
            </li>
          </ol>
        </div>
      </div>
    ...
    <div class="card">
      <div class="card-content">
        ...
        <div class="row">
          ...
          <form class="col s12" method="post" action="{{route('holiday.update', $singleHolidayData->id)}}"
            ...
            <div class="row">
              ...
              <div class="col m6  s12">
                <div class="input-field" id="view-date-picker">
                  ...
                  <input type="text" class="datepicker" name="start_date" id="start_date"
                    value="{{$singleHolidayFormatStartDate}}" required>
              ...
              <div class="col m6  s12">
                <div class="input-field" id="view-date-picker">
                  ...
                  <input type="text" class="datepicker" name="end_date" id="end_date"
                    value="{{$singleHolidayFormatEndDate}}" required>
              ...
              <div class="col m12  s12">
                <div class="input-field">
                  <input id="icon_prefix" type="text" class="validate" name="title"
                    value="{{ $singleHolidayData->title }}" required>
              ...
              <div class="input-field col s12 m12 custom-texarea-body">
                ...
                <textarea name="description" id="description" class="validate" cols="20" rows="40"
                  placeholder="Description">{{$singleHolidayData->description}}</textarea>
            ...
            <div class="row section">
              <div class="input-field col s12 m12">
                ...
                @if(isset($singleHolidayData->holiday_file) && $singleHolidayData->holiday_file != null)
                <input type="file" id="holiday_file" name="holiday_file" class="dropify"
                  data-default-file="{{asset('/backend/uploads/holidayFile/'.$singleHolidayData->holiday_file)}}" />
                @else
