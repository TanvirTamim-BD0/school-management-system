...
@section('content')
@section('title') Leave Apply @endsection
@section('leave-apply') active @endsection
@section('leave-apply.index') active @endsection
@section('styles')
@endsection
@section('content')
    ...
    <div class="container">
      <div class="row">
        <div class="col s10 m6 l6">
          <h5 class="breadcrumbs-title mt-0 mb-0"><span>Leave Apply List</span></h5>
          <ol class="breadcrumbs mb-0">
            <li class="breadcrumb-item"><a href="{{route('home')}}">Home</a>
            </li>
            <li class="breadcrumb-item"><a href="#">Leave Apply</a>
            </li>
            <li class="breadcrumb-item active">Leave Apply List
            </li>
          </ol>
        </div>
      </div>
  ...
  <div class="col s12">
    <div class="card">
      ...
      <div class="card-content custom-card-content custom-card-content-for-datatable">
        <h2 class="card-title">Leave Apply Record List</h2>
        <div class="float-right justify-content-end">
          @if(Auth::user()->can('leave-apply-create'))
          <a class="waves-effect waves dark btn gradient-45deg-purple-deep-orange next-step add-attendance-button"
            href="{{route('leave-apply.create')}}">
                ...
                <tr>
                  ...
                  <td class=" text-center">
                    ...
                    <ul id='dropdown1{{$item->id}}' class='dropdown-content custom-dropdown-for-action'>
                      <!-- <li>
                        @if(Auth::user()->can('leave-apply-edit'))
                        <a href="{{ route('leave-apply.edit',$item->id) }}"><i class="material-icons">edit</i>Edit</a>
                        @endif
                      </li> -->
                      <li>
