...
@section('content')
@section('title') Library Book Edit @endsection
          ...
          <div class="container">
            <div class="row">
              <div class="col s10 m6 l6">
                <h5 class="breadcrumbs-title mt-0 mb-0"><span>Library Book Edit</span></h5>
                <ol class="breadcrumbs mb-0">
                  <li class="breadcrumb-item"><a href="{{route('home')}}">Home</a>
                  </li>
                  <li class="breadcrumb-item"><a href="#">Library Book</a>
                  </li>
                  <li class="breadcrumb-item active">Library Book Edit
                  </li>
                </ol>
              </div>
            </div>
    ...
    <div class="col s12">
      <div class="card">
        ...
        <div class="row">
          ...
          <form class="col s12" method="post" action="{{route('libraryBook.update',$libraryBook->id)}}">
          @csrf
          @method('put')
            <div class="row">
              ...
              <div class="input-field col s12 m6">
                <select class="select2 browser-default" name="book_category_id" required>
                  ...
                  <option value="{{$singleLBCData->id}}" class="left circle" {{$singleLBCData->id == $libraryBook->book_category_id ? 'selected' : '' }}>{{$singleLBCData->book_category_name}}</option>
                  @endforeach
              ...
              <div class="input-field col s12 m6">
                <select class="select2 browser-default" name="author_id" required>
                  ...
                  <option value="{{$singleAuthor->id}}" class="left circle" {{$singleAuthor->id == $libraryBook->author_id ? 'selected' : '' }}>{{$singleAuthor->author_name}}</option>
                  @endforeach
              ...
              <div class="input-field col s12 m6">
                <select class="select2 browser-default" name="rack_no_id" required>
                  ...
                  <option value="{{$rackNo->id}}" class="left circle" {{$rackNo->id == $libraryBook->rack_no_id ? 'selected' : '' }}>
                    {{$rackNo->rack_no}}</option>
                  @endforeach
              ...
              <div class="input-field col s12 m6">
                <input id="subject_name" type="text" class="validate" name="subject_name" required value="{{$libraryBook->subject_name}}">
              ...
              <div class="input-field col s12 m6">
                <input id="mrp_price" type="number" class="validate" name="mrp_price" required value="{{$libraryBook->mrp_price}}" >
              ...
              <div class="input-field col s12 m6">
                <input id="quantity" type="text" class="validate" name="quantity" required value="{{$libraryBook->quantity}}" >
