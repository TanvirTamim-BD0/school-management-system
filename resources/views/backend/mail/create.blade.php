...
@section('content')
@section('title') Mail Create @endsection
@section('mail') active @endsection
@section('mail.create') active @endsection
@section('styles')
@endsection
@section('content')
    ...
    <div class="container">
      <div class="row">
        <div class="col s10 m6 l6">
          <h5 class="breadcrumbs-title mt-0 mb-0"><span>Mail Create</span></h5>
          <ol class="breadcrumbs mb-0">
            <li class="breadcrumb-item"><a href="{{route('home')}}">Home</a>
            </li>
            <li class="breadcrumb-item"><a href="#">Mail</a>
            </li>
            <li class="breadcrumb-item active">Mail Create
            </li>
          </ol>
        </div>
      </div>
      ...
      <div class="card-content">
        ...
        <div class="float-right">
          ...
          <a class="waves-effect waves dark btn gradient-45deg-purple-deep-orange next-step add-attendance-button"
            ...
            <i class="material-icons dp48">list</i> Mail List
          </a>
          @endif
        </div>
        ...
        <div class="row">
          ...
          <form class="col s12" method="post" action="{{route('mail.store')}}">
            @csrf
            <div class="row mt-3">
              ...
              <div class="input-field col s12 m12">
                <select class="select2 browser-default error validate custom-school-multiple-select" id="to_account_id"
                  name="to_account_id[]" data-placeholder="Mail to" multiple="multiple" required>
                  <option value="" disabled>Mail To <span class="custom-text-danger">*</span></option>
...
@section('scripts')
@include('backend.mail.partial.script')
@endsection