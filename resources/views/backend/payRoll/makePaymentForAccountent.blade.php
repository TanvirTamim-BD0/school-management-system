                                ...
                                <div class="input-field col s12 m12">
                                    <select class="select2 browser-default" name="role_id" id="role_id" required>
                                        ...
                                        <option value="{{ $singleroleData->id }}"
                                            {{ $singleroleData->id == $selectedRoleData->id ? 'selected' : '' }}>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @if(isset($userDetailData->accountent_photo) && $userDetailData->accountent_photo != null)
                                    <img src="{{ asset('/uploads/accountent_photo/'.$userDetailData->accountent_photo) }}"
                                        width="75" height="65">
                                    @else
                                ...
                                <td>
                                    @if(isset($userDetailData) && $userDetailData != null)
                                    Name: {{$userDetailData->accountent_name}} <br>
                                    Email: {{$userDetailData->accountent_email}} <br>
                                    Phone: {{$userDetailData->accountent_phone}}
                                    @endif
                                </td>
                                ...
                                <td class=" text-center">
                                    ...
                                    <a href="{{route('make-payment-for-accountent', $userDetailData->id)}}"
                                        class="mb-6 btn waves-effect waves-light gradient-45deg-green-teal 
