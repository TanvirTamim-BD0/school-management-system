                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @if(isset($userDetailData->librarian_photo) && $userDetailData->librarian_photo != null)
                                    <img src="{{ asset('/uploads/librarian_photo/'.$userDetailData->librarian_photo) }}"
                                        width="75" height="65">
                                    @else
                                ...
                                <td>
                                    @if(isset($userDetailData) && $userDetailData != null)
                                    Name: {{$userDetailData->librarian_name}} <br>
                                    Email: {{$userDetailData->librarian_email}} <br>
                                    Phone: {{$userDetailData->librarian_phone}}
                                    @endif
                                </td>
                                ...
                                <td class=" text-center">
                                    @if(Auth::user()->can('make-payment'))
                                        <a href="{{route('make-payment-for-librarian', $userDetailData->id)}}" class="mb-6 btn waves-effect waves-light gradient-45deg-green-teal 
