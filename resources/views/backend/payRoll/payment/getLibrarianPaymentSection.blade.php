...
@section('content')
@section('title') Librarian Payment List @endsection
@section('make-payment') active @endsection
@section('make-payment-for-librarian') active @endsection
@section('styles')
<style>
        ...
        <div class="container">
            <div class="row">
                <div class="col s10 m6 l6">
                    <h5 class="breadcrumbs-title mt-0 mb-0"><span>Librarian Payment List</span></h5>
                    <ol class="breadcrumbs mb-0">
                        <li class="breadcrumb-item"><a href="{{route('home')}}">Home</a>
                        </li>
                        <li class="breadcrumb-item"><a href="#">Librarian Payment</a>
                        </li>
                        <li class="breadcrumb-item active">Librarian Payment List
                        </li>
                    </ol>
                </div>
            </div>
    ...
    <div class="col s12">
        <div class="card mb-0">
            <div class="card-content custom-card-content">
                <h2 class="card-title">Librarian Payment Record List</h2>
                                        ...
                                        <div class="sidebar-details">
                                            <div class="row valign-wrapper pt-2 animate fadeLeft">
                                                <div class="col s3 media-image">
                                                    ...
                                                    @if(isset($singleLibrarianData->librarian_photo) &&
                                                    $singleLibrarianData->librarian_photo !=
                                                    null)
                                                    <img src="{{ asset('/uploads/librarian_photo/'.$singleLibrarianData->librarian_photo) }}"
                                                        width="75" height="65">
                                                    @else
                                                    @if($singleLibrarianData->gender == 'male')
                                                ...
                                                <div class="col s9 ml-10 custom-profile-data-15">
                                                    <p class="m-0 subtitle font-weight-700">
                                                        {{ Str::title($singleLibrarianData->librarian_name) }}</p>
                                                    <p class="m-0 text-muted">
                                                        {{ $singleLibrarianData->librarian_phone }}
                                                    </p>
                                                </div>
                                            </div>
                                            ...
                                            <div class="card-content custom-student-account-profile mt-10">
                                                <p><i class="material-icons profile-card-i">import_contacts</i>
                                                    <span class="custom-student-account-profile-content">
                                                        {{$singleLibrarianData->designation}}
                                                    </span>
                                                </p>
                                                <p>
                                                    <i class="material-icons profile-card-i">email</i>
                                                    <span
                                                        class="custom-student-account-profile-content">{{$singleLibrarianData->librarian_email}}</span>
                                                </p>
                                                <p><i class="material-icons profile-card-i">person_outline</i>
                                                    <span class="custom-student-account-profile-content">
                                                        {{Str::title($singleLibrarianData->gender)}} <span
                                                            class="custom-text-info">({{$singleLibrarianData->blood_group}})</span>
                                                    </span>
                                                </p>
                                                <p><i class="material-icons profile-card-i">eject</i>
                                                    <span class="custom-student-account-profile-content">
                                                        {{$singleLibrarianData->religion}}
                                                    </span>
                                                </p>
                                                <p>
                                                    <i class="material-icons profile-card-i">directions</i>
                                                    <span
                                                        class="custom-student-account-profile-content">{{$singleLibrarianData->address}}</span>
                                                </p>
                                ...
                                <div class="card-content">
                                    ...
                                    <ul class="tabs mb-2 row custom-user-payment-tab">
                                        <li class="tab">
                                            <a class="display-flex align-items-center active" id="account-tab"
                                                href="#paymentHistory">
                                                <i class="material-icons mr-2">error_outline</i><span>Librarian Payment History</span>
                                            </a>
                                        </li>
                                    ...
                                    <div class="row">
                                                            ...
                                                            <td class=" text-center">
                                                                ...
                                                                <ul id='dropdown{{$item->id}}'
                                                                    ...
                                                                    <li>
                                                                        ...
                                                                        <a
                                                                            href="{{route('get-librarian-payment-invoice', $item->id)}}"><i
                                        ...
                                        <div class="col s12" id="addNewPayment">
                                            <h2 class="card-title custom-payment-title mt-2">Librarian Payment Create
                                            </h2>
                                            <div class="divider"></div>

                                            <div class="row mt-4">

                                                <form method="post" action="{{route('add-make-payment-for-librarian')}}"
                                                    enctype="multipart/form-data">
                                                    @csrf
                                                    <input type="hidden" name="payment_to_id" id="payment_to_id"
                                                        value="{{ $singleLibrarianData->id }}">
                                                    <div class="row">
                                                        ...
                                                        <div class="input-field col s12 m6">
                                                            <input id="total_salary" type="number" class="validate custom-readonly"
                                                                ...
                                                                value="{{$singleLibrarianData->salary}}">
