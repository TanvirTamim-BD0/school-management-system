...
@section('content')
@section('title') Student Payment @endsection
    ...
    <div class="container">
      <div class="row">
        <div class="col s10 m6 l6">
          <h5 class="breadcrumbs-title mt-0 mb-0"><span>Student Payment Filter</span></h5>
          <ol class="breadcrumbs mb-0">
            <li class="breadcrumb-item"><a href="{{route('home')}}">Home</a>
            </li>
            <li class="breadcrumb-item"><a href="#">Student Payment</a>
            </li>
            <li class="breadcrumb-item active">Student Payment Filter
            </li>
          </ol>
        </div>
      </div>
  ...
  <div class="col s12">
    <div class="card">
      ...
      <div class="card-content custom-table-filtering-header">
        ...
        <form method="post" action="{{route('payment-of-student.account-section')}}" enctype="multipart/form-data">
          @csrf
          <div class="row">
