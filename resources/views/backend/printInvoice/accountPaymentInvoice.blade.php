...
@section('content')
@section('title') Account Payment Invoice @endsection
                    ...
                    <div class="card-content invoice-print-area">
                        ...
                        <div class="row invoice-info">
                            ...
                            <div class="col m6 s12 custom-text-right">
                                ...
                                <div class="invoice-address">
                                    <span>{{$invoiceData['accountent_name']}}</span>
                                </div>
                                <div class="invoice-address">
                                    @if(isset($invoiceData['address']) && $invoiceData['address'] != null)
                                    <span>{{$invoiceData['address']}}</span>
                                ...
                                <div class="invoice-address">
                                    @if(isset($invoiceData['accountent_email']) && $invoiceData['accountent_email'] != null)
                                    <span>{{$invoiceData['accountent_email']}}</span>
                                    @else
                                    <span>sampleemail@gmail.com</span>
                                    @endif
                                </div>
                                <div class="invoice-address">
                                    @if(isset($invoiceData['accountent_phone']) && $invoiceData['accountent_phone'] != null)
                                    <span>{{$invoiceData['accountent_phone']}}</span>
                                    @else
                                    <span>+8801000000000</span>
                                    @endif
                                </div>
