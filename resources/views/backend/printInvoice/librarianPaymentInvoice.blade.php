                    ...
                    <div class="card-content invoice-print-area">
                        ...
                        <div class="row invoice-info">
                            ...
                            <div class="col m6 s12 custom-text-right">
                                ...
                                <div class="invoice-address">
                                    <span>{{$invoiceData['librarian_name']}}</span>
                                </div>
                                <div class="invoice-address">
                                    @if(isset($invoiceData['address']) && $invoiceData['address'] != null)
                                    <span>{{$invoiceData['address']}}</span>
                                ...
                                <div class="invoice-address">
                                    @if(isset($invoiceData['librarian_email']) && $invoiceData['librarian_email'] != null)
                                    <span>{{$invoiceData['librarian_email']}}</span>
                                    @else
                                    <span>sampleemail@gmail.com</span>
                                    @endif
                                </div>
                                <div class="invoice-address">
                                    @if(isset($invoiceData['librarian_phone']) && $invoiceData['librarian_phone'] != null)
                                    <span>{{$invoiceData['librarian_phone']}}</span>
                                    @else
                                    <span>+8801000000000</span>
                                    @endif
                                </div>
