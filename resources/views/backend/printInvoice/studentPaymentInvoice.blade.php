...
@section('content')
@section('title') Student Payment Invoice @endsection
                    ...
                    <div class="card-content invoice-print-area">
                        ...
                        <div class="row invoice-info">
                            ...
                            <div class="col m6 s12 custom-text-right">
                                ...
                                <div class="invoice-address">
                                    <span>{{$invoiceData['student_name']}}</span>
                                </div>
                                <div class="invoice-address">
                                    @if(isset($invoiceData['address']) && $invoiceData['address'] != null)
                                    <span>{{$invoiceData['address']}}</span>
                                ...
                                <div class="invoice-address">
                                    @if(isset($invoiceData['student_email']) && $invoiceData['student_email'] != null)
                                    <span>{{$invoiceData['student_email']}}</span>
                                    @else
                                    <span>sampleemail@gmail.com</span>
                                    @endif
                                </div>
                                <div class="invoice-address">
                                    @if(isset($invoiceData['student_phone']) && $invoiceData['student_phone'] != null)
                                    <span>{{$invoiceData['student_phone']}}</span>
                                    @else
                                    <span>+8801000000000</span>
                                    @endif
                                </div>
                        ...
                        <div class="invoice-product-details mt-15">
                            <table class="striped responsive-table custom-text-center custom-border-invoice-table">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="custom-text-center">{{ $invoiceData['payment_date'] }}</td>
