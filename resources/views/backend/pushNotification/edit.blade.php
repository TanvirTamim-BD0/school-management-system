...
@section('content')
@section('title') Push Notification Update @endsection
        ...
        <div class="container">
            <div class="row">
                <div class="col s10 m6 l6">
                    <h5 class="breadcrumbs-title mt-0 mb-0"><span>Timely Push Notification Update</span></h5>
                    <ol class="breadcrumbs mb-0">
                        <li class="breadcrumb-item"><a href="{{route('home')}}">Home</a>
                        </li>
                        <li class="breadcrumb-item"><a href="#">Push Notification </a>
                        </li>
                        <li class="breadcrumb-item active">Push Notification Update
                        </li>
                    </ol>
                </div>
            </div>
        ...
        <div class="card">
            <div class="card-content">
                ...
                <div class="row">
                    ...
                    <form class="col s12" method="post" action="{{route('push-notification.update', $pushNotification->id)}}" enctype="multipart/form-data">
                        @csrf
                        @method('put')
                        <div class="row">
                            ...
                            <div class="input-field col m6  s12" id="view-date-picker">
                                ...
                                <input type="text" class="datepicker" name="sending_date" id="sending_date"
                            ...
                            <div class="input-field col m6  s12" id="view-date-picker">
                                ...
                                <input id="sending_time" type="text" class="timepicker" name="sending_time" required
                                    value="{{$sendingTime}}">
                            ...
                            <div class="input-field col s12 m12">
                                <input id="icon_prefix" type="text" class="validate" name="notification_title" required
                                    value="{{ $pushNotification->notification_title }}">
                            ...
                            <div class="input-field col s12 m12">
                                <input id="icon_prefix" type="text" class="validate" name="notification_message"
                                    required value="{{ $pushNotification->notification_message }}">
