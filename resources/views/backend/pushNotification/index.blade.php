    ...
    <div class="container">
      <div class="row">
        <div class="col s10 m6 l6">
          <h5 class="breadcrumbs-title mt-0 mb-0"><span>Push Notification Timely</span></h5>
      ...
      <div class="card-content custom-card-content custom-card-content-for-datatable">
        ...
        <div class="float-right justify-content-end">
          ...
          <a class="waves-effect waves dark btn gradient-45deg-purple-deep-orange next-step add-attendance-button"
            href="{{route('push-notification.create')}}">
        ...
        <table id="classTable"
          ...
          <thead>
            <tr>
              ...
              <th class="custom-border-right">Title/Message</th>
              <th class="custom-border-right">Date/Time</th>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                Title: {{$item->notification_title}} <br>
              ...
              <td class=" text-center">
                ...
                <ul id='dropdown1{{$item->id}}' class='dropdown-content custom-dropdown-for-action'>
                  <li>
                    @if(Auth::user()->can('push-notification'))
                    <a href="{{ route('push-notification.edit',$item->id) }}"><i class="material-icons">edit</i>Edit</a>
                    @endif
                  </li>
