...
@section('content')
@section('title') Rack No Create @endsection
@section('rackNo') active @endsection
@section('rackNo.create') active @endsection
@section('styles')
@endsection
@section('content')
    ...
    <div class="container">
      <div class="row">
        <div class="col s10 m6 l6">
          <h5 class="breadcrumbs-title mt-0 mb-0"><span>Rack No Create</span></h5>
          <ol class="breadcrumbs mb-0">
            <li class="breadcrumb-item"><a href="{{route('home')}}">Home</a>
            </li>
            <li class="breadcrumb-item"><a href="#">Rack No</a>
            </li>
            <li class="breadcrumb-item active">Rack No Create
            </li>
          </ol>
        </div>
      </div>
    ...
    <div class="card">
      <div class="card-content">
        ...
        <div class="row">
          ...
          <form class="col s12" method="post" action="{{route('rackNo.store')}}">
            @csrf
            <div class="row">
              <div class="input-field col s12 m8">
                <input id="icon_prefix" type="text" class="validate" name="rack_no" required value="{{ old('rack_no') }}" >
