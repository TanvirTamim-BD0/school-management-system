...
@section('content')
@section('title') Addmission Report Invoice @endsection
                        ...
                        <div class="invoice-product-details">
                            <table class="striped responsive-table custom-text-center custom-border-invoice-table">
                                <thead class="bg-light custom-bg-light">
                                    <tr>
					                    <th class="custom-border-right text-center">SL</th>
					                    <th class="custom-border-right text-center">Class</th>
					                    <th class="custom-border-right text-center">Admission Name</th>
					                    <th class="custom-border-right text-center">Fees</th>
					                 </tr>
                                </thead>
                                <tbody>
