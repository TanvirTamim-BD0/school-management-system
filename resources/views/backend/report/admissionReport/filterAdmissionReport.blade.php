...
@section('content')
@section('title') Addmission Report Filter @endsection
    ...
    <div class="container">
      <div class="row">
        <div class="col s10 m6 l6">
          <h5 class="breadcrumbs-title mt-0 mb-0"><span>Addmission Report Filter</span></h5>
          <ol class="breadcrumbs mb-0">
            <li class="breadcrumb-item"><a href="{{route('home')}}">Home</a>
            </li>
            <li class="breadcrumb-item"><a href="#">Addmission Report Filter</a>
            </li>
            <li class="breadcrumb-item active">Addmission Report Filter
            </li>
          </ol>
        </div>
      </div>
  ...
  <div class="col s12">
    <div class="card">
      ...
      <div class="card-content custom-table-filtering-header">
        <form method="post" action="{{route('report-of-addmission-filter')}}" enctype="multipart/form-data">
          @csrf
          <div class="row">
