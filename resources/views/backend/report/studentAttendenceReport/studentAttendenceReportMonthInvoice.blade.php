...
@section('content')
@section('title') Student Attendence Month Invoice @endsection
            ...
            <div class="col xl12 m12 s12" style="">
                <div class="card">
                    <div class="card-content invoice-print-area">
                        ...
                        <div class="invoice-product-details" id="courseAttendanceWitMonth">
                            <table class="striped responsive-table custom-text-center custom-border-invoice-table">
				                ...
				                <tr>
				                  <td class="font-weight-bold custom-border-right text-center" style="color: #00CFE8 !important;">
