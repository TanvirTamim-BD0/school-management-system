...
@section('content')
@section('title') Student Invoice @endsection
                            ...
                            <table class="striped responsive-table custom-text-center custom-border-invoice-table">
                                <thead class="bg-light custom-bg-light">
                                    <tr>
                                      ...
                                      <th class="custom-border-right text-center">Photo</th>
                                      <th class="custom-border-right text-center">Student Details</th>
                                      <th class="custom-border-right text-center">Academic</th>
                                    </tr>
                                </thead>
                                <tbody>
