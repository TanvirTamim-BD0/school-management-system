...
@section('all-student-result-filter') active @endsection
@section('all-student-result-filter') active @endsection
@section('styles')
@endsection
    ...
    <div class="col s12">
        <div class="card">
            ...
            <div class="card-content custom-table-filtering-header">
                <div class="row">
                    <form method="post" action="{{route('get-all-student-result')}}" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col m6  s12">
                                <div class="input-field">
                                    <select class="select2 browser-default" id="class_id" name="class_id" required>
                                        ...
                                        <option value="{{ $singleClassData->id }}">{{ $singleClassData->class_name }}
                                        </option>
                                        @endif
                                        @endforeach
                                    </select>
                            ...
                            <div class="col m6  s12">
                                <div class="input-field">
                                    <select class="select2 browser-default" name="subject_id" id="subject_id" required>
                                        <option value="" selected disabled>Select Subject <span
                                                class="custom-text-danger">*</span></option>
                            ...
                            <div class="col m6  s12">
                                <div class="input-field">
                                    <select class="select2 browser-default" id="exam_id" name="exam_id" required>
                                        <option value="" selected disabled>Select Exam <span
                                                class="custom-text-danger">*</span></option>
