...
<div class="float-right ">
  <form class="col s12" method="post" action="{{route('student-id-card-invoice')}}" enctype="multipart/form-data">
    @csrf
    <input type="hidden" name="class_id" value="{{$studentData->class_id}}">
    <input type="hidden" name="section_id" value="{{$studentData->section_id}}">
