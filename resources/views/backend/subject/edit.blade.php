    ...
    <div class="container">
      <div class="row">
        <div class="col s10 m6 l6">
          <h5 class="breadcrumbs-title mt-0 mb-0"><span>Subject Edit</span></h5>
          <ol class="breadcrumbs mb-0">
            <li class="breadcrumb-item"><a href="{{route('home')}}">Home</a>
            </li>
            <li class="breadcrumb-item"><a href="#">Subject</a>
            </li>
            <li class="breadcrumb-item active">Subject Edit
            </li>
          </ol>
        </div>
      </div>
    ...
    <div class="card">
      <div class="card-content">
        ...
        <div class="row">
          ...
          <form class="col s12" method="post" action="{{route('subject.update',$subject->id)}}">
            @csrf
            @method('put')
            <div class="row">
              <div class="input-field col s12 m6">
                <input id="icon_prefix" type="text" class="validate" name="subject_name"
              ...
              <div class="input-field col s12 m6">
                <select class="select2 browser-default" name="class_id" required>
                  ...
                  <option value="{{$class->id}}" class="left circle"
                    {{ $class->id == $subject->class_id ? "selected":"" }}>{{$class->class_name}}</option>
                  @endforeach
