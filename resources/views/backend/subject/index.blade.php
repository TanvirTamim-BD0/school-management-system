...
@section('subject.index') active @endsection
@section('styles')
@endsection
@section('content')
    ...
    <div class="container">
      <div class="row">
        <div class="col s10 m6 l6">
          <h5 class="breadcrumbs-title mt-0 mb-0"><span>Subject List</span></h5>
          <ol class="breadcrumbs mb-0">
            <li class="breadcrumb-item"><a href="{{route('home')}}">Home</a>
            </li>
            <li class="breadcrumb-item"><a href="#">Subject</a>
            </li>
            <li class="breadcrumb-item active">Subject List
            </li>
          </ol>
        </div>
      </div>
  ...
  <div class="col s12">
    <div class="card">
      ...
      <div class="card-content custom-card-content custom-card-content-for-datatable">
        <h2 class="card-title">Subject Record List</h2>
        <div class="float-right justify-content-end">
          @if(Auth::user()->can('subject-create'))
          <a class="waves-effect waves dark btn gradient-45deg-purple-deep-orange next-step add-attendance-button"
            href="{{route('subject.create')}}">
            <i class="material-icons dp48">add_circle_outline</i> Add Subject
          </a>
          @endif
        </div>
      </div>
        ...
        <table id="sectionTable"
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>{{$subject->classData->class_name}}</td>


              <td class=" text-center">
                <!-- Dropdown Trigger -->
                <a class='dropdown-trigger btn custom-dropdown-btn' href='#' data-target='dropdown1{{$subject->id}}'>
                  <i class="material-icons float-right">more_vert</i>
                </a>
                <!-- Dropdown Structure -->
                <ul id='dropdown1{{$subject->id}}' class='dropdown-content custom-dropdown-for-action'>

                  @if(Auth::user()->can('subject-edit'))
                  <li>
                    <a href="{{ route('subject.edit',$subject->id) }}"><i class="material-icons">edit</i>Edit</a>
                  </li>
                  @endif
