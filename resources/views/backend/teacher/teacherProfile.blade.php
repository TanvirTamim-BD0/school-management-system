        ...
        <div class="container">
            <div class="row">
                <div class="col s10 m6 l6">
                    <h5 class="breadcrumbs-title mt-0 mb-0"><span>Teacher Profile</span></h5>
    ...
    <div class="col s12">
        <div class="card mb-0">
            <div class="card-content custom-card-content">
                <h2 class="card-title">Teacher Profile</h2>
                                        ...
                                        <div class="sidebar-details">
                                            ...
                                            <div class="card-content custom-student-account-profile mt-10">
                                                ...
                                                <p>
                                                    ...
                                                    <span
                                                        class="custom-student-account-profile-content">{{$teacher->teacher_name}}</span>
                                                </p>

                                                <p>
                                                    <i class="material-icons profile-card-i">call</i>
                                                    <span
                                                        class="custom-student-account-profile-content">{{$teacher->teacher_phone}}</span>
                                                </p>

                                                <p>
                                                    <i class="material-icons profile-card-i">email</i>
                                                    <span
                                                        class="custom-student-account-profile-content">{{$teacher->teacher_email}}</span>
                                                </p>
                                                ...
                                                <p>
                                                    ...
                                                    <span
                                                        class="custom-student-account-profile-content">{{$teacher->address}}</span>
                                                </p>

                                                <p>
                                                    <i class="material-icons profile-card-i">assignment_add</i>
                                                    <span
                                                        class="custom-student-account-profile-content">{{Carbon\Carbon::createFromFormat('Y-m-d', $teacher->joining_date)->format('d-m-Y')}}</span>
                                                </p>
                                            ...
                                            <div id="attendanceWitMonth">
                                                <table
                                                    ...
                                                    <tbody>
                                                        ...
                                                        @php
                                                        $presentData =
                                                        App\Models\TeacherAttendance::presentDataWithMonth($month,$teacher->id);
                                                        $absenceData =
                                                        App\Models\TeacherAttendance::absenceDataWithMonth($month,$teacher->id);
                                                        $lateData =
                                                        App\Models\TeacherAttendance::lateDataWithMonth($month,
                                                        $teacher->id);
                                                        $leaveData =
                                                        App\Models\TeacherAttendance::leaveDataWithMonth($month,
                                                        $teacher->id);
                                                        @endphp
                                                        ...
                                                        <tr>
                                                            <td class="font-weight-bold text-left">
                                                                ...
                                                                <a href="#" onclick="teacherAttendense({{$teacher->id}},'{{$month}}')">
                                                                    {{ $month }}
                                                                </a>
...
<script>
    //To fetch the course days attendance with month...
		    function teacherAttendense(teacherId, monthName) {

		        var url = "{{ route('teacher.daysAttendanceWithMonth') }}";
		        if(teacherId != ''){
		            $.ajaxSetup({
		                headers: {
